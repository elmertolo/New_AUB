...
namespace New_AUB.Services
{
    class ProcessServices
    {
        ...
        public void DoBlockProcessRB(List<OrderModelRb> _checks, frmMain _mainForm)
        {
        ...
        public void PackingTextRB(List<OrderModelRb> _checksModel, frmMain _mainForm)
        {
        ...
        public void SaveToPackingDBFRb(List<OrderModelRb> _checks, string _batchNumber, frmMain _mainForm)
        {
            string dbConnection;
            string tempCheckType = "";
            int blockNo = 0, blockCounter = 0;
        ...
        public void PrinterFileRb(List<OrderModelRb> _checkModel, frmMain _mainForm)
        {
